                                      ...
                                      DropdownMenu(
                                          ...
                                          dropdownMenuEntries: [
                                            ...
                                            DropdownMenuEntry(
                                                value: 10,
                                                label:
                                                    '${focusTimes[10]} minute'),
                                            DropdownMenuEntry(
                                                value: 11,
                                                label:
                                                    '${focusTimes[11]} minute'),
                                            DropdownMenuEntry(
                                                value: 12,
                                                label:
                                                    '${focusTimes[12]} minute'),
                                            DropdownMenuEntry(
                                                value: 13,
                                                label:
                                                    '${focusTimes[13]} minute'),
                                            DropdownMenuEntry(
                                                value: 14,
                                                label:
                                                    '${focusTimes[14]} minute'),
                                            DropdownMenuEntry(
                                                value: 15,
                                                label:
                                                    '${focusTimes[15]} minute'),
                                            DropdownMenuEntry(
                                                value: 16,
                                                label:
                                                    '${focusTimes[16]} minute'),
                                            DropdownMenuEntry(
                                                value: 17,
                                                label:
                                                    '${focusTimes[17]} minute'),
                                            DropdownMenuEntry(
                                                value: 18,
                                                label:
                                                    '${focusTimes[18]} minute'),
                                          ]),
                                      DropdownMenu(
                                          onSelected: (v) {
                                            breakEndTime =
                                                (breakTimes[v!] - 1).toDouble();
                                          },
                                          initialSelection: 0,
                                          menuHeight: 150,
                                          label: Text(
